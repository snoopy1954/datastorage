...
import { SET_ADDRESSES, ADD_ADDRESS, UPDATE_ADDRESS, REMOVE_ADDRESS, EXCHANGE_ADDRESSES, ActionTypes } from './types';

const initialState: Address[] = [];

export const addressesReducer = (state = initialState, action: ActionTypes): Address[] => {
    switch (action.type) {
        case SET_ADDRESSES:
            return {
                ...state,
