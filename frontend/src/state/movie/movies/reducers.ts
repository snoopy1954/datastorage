...
import { SET_MOVIES, ADD_MOVIE, UPDATE_MOVIE, REMOVE_MOVIE, EXCHANGE_MOVIES, ActionTypes } from './types';

const initialState: Movie[] = [];

export const moviesReducer = (state = initialState, action: ActionTypes): Movie[] => {
    switch (action.type) {
        case SET_MOVIES:
            return {
                ...state,
