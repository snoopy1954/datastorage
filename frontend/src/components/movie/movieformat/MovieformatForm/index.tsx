...
import { FormatNoID, Format } from '../../../../../../backend/src/types/basic';

import { RootState } from '../../../../state/store';

import { TextField } from '../../../basic/formfields/textfield';

import { newFormat } from '../../../../utils/movie/movieformat';
...
export const MovieformatForm: React.FC<Props> = ({ edittype, onSubmit, onCancel }) => {
  const movieformat: Format = useSelector((state: RootState) => state.movieformat);

  const initialValues = (edittype===Edittype.EDIT && movieformat) ? movieformat : newFormat();
