...
import { addSportgroup, updateSportgroup, removeSportgroup } from '../../../../state/sport/groups/actions';
import { setSelectedGroup, clearSelectedGroup } from '../../../../state/sport/group/actions';
...
export const GroupPage: React.FC = () => {
  ...
  const group: Group = useSelector((state: RootState) => state.sportgroup);      
  ...
  const actionChange = async (values: GroupNoID) => {
    ...
    dispatch(updateSportgroup(groupToChange));
    dispatch(clearSelectedGroup());
    closeModal();
  };
  
  const actionDelete = () => {
    dispatch(removeSportgroup(group.id));
    dispatch(clearSelectedGroup());
    closeModal();
  };  
